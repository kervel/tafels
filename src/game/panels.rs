...
fn char_bitmap(c: char) -> Option<[u8; 7]> {
    match c {
        ...
        '=' => Some([0b00000, 0b11111, 0b00000, 0b00000, 0b11111, 0b00000, 0b00000]),
        '?' => Some([0b01110, 0b10001, 0b00001, 0b00110, 0b00100, 0b00000, 0b00100]),
        's' => Some([0b00000, 0b01111, 0b10000, 0b01110, 0b00001, 0b11110, 0b00000]),
...
pub fn render_text_texture(
    ...
    let chars: Vec<[u8; 7]> = text
        .chars()
        .filter_map(char_bitmap)
        .collect();
